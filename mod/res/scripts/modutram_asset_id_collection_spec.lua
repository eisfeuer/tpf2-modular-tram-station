...
describe('AssetIdCollection', function ()
    ...
    describe('add_asset_id', function ()
        it ('adds asset id', function ()
            local asset_id_collection = AssetIdCollection:new{}
            asset_id_collection:add_asset_id(t.ASSET_DECORATION, 3)
            asset_id_collection:add_asset_id(t.ASSET_SHELTER, 4)
            asset_id_collection:add_asset_id(t.ASSET_DECORATION, 5)

            assert.are.same({
                [t.ASSET_DECORATION] = {3, 5},
                [t.ASSET_SHELTER] = {4}
